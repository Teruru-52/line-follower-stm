...
# BASED ON /home/terunuma/Documents/rogy/line-follower-stm
...
target_include_directories(
    ...
    "$<$<AND:$<CONFIG:Debug>,$<COMPILE_LANGUAGE:C>>:${PROJECT_SOURCE_DIR}/Middlewares/Third_Party/LwIP/src/include/compat/posix/net>"
    ...
    "$<$<AND:$<NOT:$<CONFIG:Debug>>,$<COMPILE_LANGUAGE:C>>:${PROJECT_SOURCE_DIR}/Middlewares/Third_Party/LwIP/src/include/compat/posix/net>"
...
target_link_directories(
    ${TARGET_NAME} PRIVATE
    "$<$<CONFIG:Debug>:/home/terunuma/Documents/rogy/line-follower-stm/micro_ros_stm32cubemx_utils/microros_static_library_ide/libmicroros>"
)
...
separate_arguments(
    ...
    "docker pull microros/micro_ros_static_library_builder:humble && docker run --rm -v /home/terunuma/Documents/rogy/line-follower-stm:/project --env MICROROS_LIBRARY_FOLDER=micro_ros_stm32cubemx_utils/microros_static_library_ide microros/micro_ros_static_library_builder:humble"
)
